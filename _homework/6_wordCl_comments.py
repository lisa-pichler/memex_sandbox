...
import matplotlib.pyplot as plt ##matplotlib also where we find colours
...
if response.lower() == "yes":
    ...
    functions.removeFilesOfType(settings["path_to_memex"], "_wCloud.jpg") #removes existing fiels and generates new ones
    print("Generating new files...")
    generateTfIdfWordClouds(settings["path_to_memex"]) #function checks if it already exists, thats why it has to be removed first
else:
